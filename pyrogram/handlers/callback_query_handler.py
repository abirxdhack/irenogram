...
class CallbackQueryHandler(Handler):
    ...
    async def check_if_has_matching_listener(
        ...
        :return: A tuple of a boolean and a Listener object. The boolean indicates whether the found listener has filters and its filters matches with the CallbackQuery object. The Listener object is the matching listener.
        """
    ...
    async def check(self, client: "pyrogram.Client", query: CallbackQuery):
        ...
        :param client: The Client object to check with.
        :param query: The CallbackQuery object to check with.
        :return: A boolean indicating whether the CallbackQuery object has a matching listener or the handler filter matches.
        """
