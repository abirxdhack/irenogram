...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *update* argument type will vary depending on which :obj:`~pyrogram.handlers.Handler` is coming from. 
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    When a pattern matches, all the `Match Objects <https://docs.python.org/3/library/re.html#match-objects>`_ stored in the ``matches`` field of the update object itself.
...
class user(Filter, set):
    ...
    You can use `set bound methods <https://docs.python.org/3/library/stdtypes.html#set>`_ on the users container.
...
class chat(Filter, set):
    ...
    You can use `set bound methods <https://docs.python.org/3/library/stdtypes.html#set>`_ on the chats container.
...
class topic(Filter, set):
    ...
    You can use `set bound methods <https://docs.python.org/3/library/stdtypes.html#set>`_ on the topics container.
    Parameters:
        topics (``int`` | ``list``):
