...
class Message(Object, Update):
    ...
    Parameters:
        ...
        change_creator_user_id (``int``, *optional*):
            Service message: ID of the user who was made the new group/channel creator.

        new_creator_pending_user_id (``int``, *optional*):
            Service message: ID of the user whose creator transfer is pending confirmation.

        no_forwards_enabled (``bool``, *optional*):
            Service message: new value of the no-forwards restriction after toggle.
            ``True`` means forwards were disabled, ``False`` means they were re-enabled.

        no_forwards_request_expired (``bool``, *optional*):
            Service message: True if the no-forwards request has expired (for
            ``messageActionNoForwardsRequest``).

        gift_purchase_offer (:obj:`~pyrogram.types.Gift`, *optional*):
            Service message: the star gift that was offered for purchase.

        gift_purchase_offer_accepted (``bool``, *optional*):
            True if the gift purchase offer was accepted.

        gift_purchase_offer_declined (``bool``, *optional*):
            True if the gift purchase offer was declined.

        birthday_suggestion (:obj:`~pyrogram.types.Birthday`, *optional*):
            Service message: birthday date suggested for the chat user.
    ...
    def __init__(
        ...
        *,
        ...
        change_creator_user_id: int = None,
        new_creator_pending_user_id: int = None,
        no_forwards_enabled: bool = None,
        no_forwards_request_expired: bool = None,
        gift_purchase_offer: "types.Gift" = None,
        gift_purchase_offer_accepted: bool = None,
        gift_purchase_offer_declined: bool = None,
        birthday_suggestion: "types.Birthday" = None,
        managed_bot_created_bot_id: int = None,
        ...
        self.change_creator_user_id = change_creator_user_id
        self.new_creator_pending_user_id = new_creator_pending_user_id
        self.no_forwards_enabled = no_forwards_enabled
        self.no_forwards_request_expired = no_forwards_request_expired
        self.gift_purchase_offer = gift_purchase_offer
        self.gift_purchase_offer_accepted = gift_purchase_offer_accepted
        self.gift_purchase_offer_declined = gift_purchase_offer_declined
        self.birthday_suggestion = birthday_suggestion
        self.managed_bot_created_bot_id = managed_bot_created_bot_id
    ...
    async def _parse(
        ...
        if isinstance(message, raw.types.MessageService):
            ...
            change_creator_user_id = None
            new_creator_pending_user_id = None
            no_forwards_enabled = None
            no_forwards_request_expired = None
            gift_purchase_offer = None
            gift_purchase_offer_accepted = None
            gift_purchase_offer_declined = None
            birthday_suggestion = None
            managed_bot_created_bot_id = None
            ...
            parsed_message = Message(
                ...
                change_creator_user_id=change_creator_user_id,
                new_creator_pending_user_id=new_creator_pending_user_id,
                no_forwards_enabled=no_forwards_enabled,
                no_forwards_request_expired=no_forwards_request_expired,
                gift_purchase_offer=gift_purchase_offer,
                gift_purchase_offer_accepted=gift_purchase_offer_accepted,
                gift_purchase_offer_declined=gift_purchase_offer_declined,
                birthday_suggestion=birthday_suggestion,
                managed_bot_created_bot_id=managed_bot_created_bot_id,
                raw=message,
    ...
    async def reply_web_page(
        ...
        Example:
            .. code-block:: python
                ...
                await message.reply_web_page("https://github.com/abirxdhack/irenogram")
