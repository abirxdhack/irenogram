...
class Message(Object, Update):
    ...
    async def _parse_service(
        ...
        if isinstance(action, raw.types.MessageActionGameScore):
            ...
            parsed_message.pinned_message = parsed_message.reply_to_message
        ...
        if media:
            if isinstance(media, raw.types.MessageMediaPhoto):
                photo = types.Photo._parse(
                    ...
                    media.photo,
                    media.ttl_seconds,
                    is_live_photo=getattr(media, "live_photo", None)
                )
    ...
    async def reply_poll(
        ...
        * reply_parameters
        ...
        Parameters:
            ...
            options (List of ``str`` | List of :obj:`~pyrogram.types.InputPollOption`):
            ...
            correct_option_id (``int``, *optional*):
                0-based identifier of the correct answer option for single-answer quizzes.
                Alternative to ``correct_option_ids``.
        ...
        * reply_parameters
        ...
        Parameters:
            emoji (``str``, *optional*):
                ...
                Dice can have values 1-6 for "ðŸŽ²", "ðŸŽ¯" and "ðŸŽ³", values 1-5 for "ðŸ€" and "âš½", and
                values 1-64 for "ðŸŽ°".
                Defaults to "ðŸŽ²".
