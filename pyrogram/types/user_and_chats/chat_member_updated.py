...
class ChatMemberUpdated(Object, Update):
    ...
    async def get_chat(self):
        """Bound method *get_chat* of :obj:`~pyrogram.types.ChatMemberUpdated`.
        ...
        Example:
            .. code-block:: python
               ...
               await chat_member_updated.get_chat()
        """
        return await self._client.get_chat(self.chat.id)

    async def get_member(self):
        """Bound method *get_member* of :obj:`~pyrogram.types.ChatMemberUpdated`.
        ...
        Example:
            .. code-block:: python
               ...
               await chat_member_updated.get_member()
        """
