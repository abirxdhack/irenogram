...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        matches (List of regex Matches, *optional*):
            ...
            that match the query of this inline query. Only applicable when using :obj:`~pyrogram.filters.regex`.
    """
    ...
    async def answer(
        ...
        Parameters:
            ...
            switch_pm_parameter (``str``, *optional*):
                `Deep-linking <https://core.telegram.org/bots#deep-linking>`_ parameter sent to the bot when user presses the switch button. 1-64 characters, only A-Z, a-z, 0-9, _ and - are allowed.
