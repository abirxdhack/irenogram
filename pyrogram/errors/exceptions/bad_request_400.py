...
# Copyright (C) 2025-present Abir Arafat Chawdhury <https://github.com/abirc8010>
#
# This file is part of Irenogram.
#
# Based on Pyrogram, originally created by Dan.
#
...
#
# Maintainer: Abir Arafat Chawdhury (2025–Present)
...
class AnswerXMediaTypeInvalid(BadRequest):
...
class InputFetchErrorx(BadRequest):
...
class StoryLiveAlreadyx(BadRequest):
